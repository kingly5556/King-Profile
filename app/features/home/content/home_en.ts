...
export const PORTFOLIO_PROJECTS_EN: PortfolioProject[] = [
  ...
  },
  {
    ...
    bullets: [
      "Provides a secure and scalable backend infrastructure using Node.js and Express, serving as the Single Source of Truth.",
      "Offers full-featured REST APIs for User Authentication, Novel & Chapter Management, User Profiles, and Social Interactions (Follow, Bookmark, Comment).",
      "Features an intelligent AI Writing Assistant powered by a Python FastAPI internal service, securely accessible via backend proxy.",
      "Ensures high security with a custom JWT Authentication system supporting Access and Refresh Token rotation.",
