...
/** Display name in header / footer */
export const SITE_BRAND = "Kongkat Thanalertrungroj";

/** Local hero portrait. */
export const HERO_PORTRAIT_SRC = "/hero-portrait.jpg";

/** Hero display name — two lines for balanced wrapping (long surname). */
export const HERO_HEADLINE_NAME_LINES = ["Kongkat", "Thanalertrungroj"] as const;

export const HERO_HEADLINE_ROLE = "PROGRAMMER & AI ENGINEER" as const;
...
/** Section `id`s in scroll order (top → bottom). Used by header scroll-spy. */
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  {
    ...
    ctaLabel: "Email me",
    ctaHref: `mailto:${CONTACT_EMAIL}?subject=Data%20Center%20project`,
  ...
  },
  {
    ...
    ctaLabel: "Email me",
    ctaHref: `mailto:${CONTACT_EMAIL}?subject=GPA%20Prediction%20Model%20project`,
